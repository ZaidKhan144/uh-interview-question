...
$(document).ready(function() {
    if ($('.page-section:first-of-type').hasClass('theme-light-gray')) {
        $('.nav-breadcrumb').addClass('theme-light-gray')
    };
    if ($('.page-section:first-of-type').hasClass('theme-cream')) {
        $('.nav-breadcrumb').addClass('theme-cream')
    };
    if ($('.page-section:first-of-type').hasClass('theme-brick')) {
        $('.nav-breadcrumb').addClass('theme-brick')
    };
    if ($('.page-section:first-of-type').hasClass('theme-slate')) {
        $('.nav-breadcrumb').addClass('theme-slate')
    };
});
